  ...
  ask patches [
    ...
    if random 100 < density [   ; set the occupancy density
      sprout 1 [
        ...
        ; 45 is the color number for "yellow"
        ; 55 is the color number for "green"
        ; 135 is the color number for "pink"
        set color one-of [105 27 45 55 135]
        set size 1
      ]
    ]
  ]
...
This project models the behavior of five types of agents in a neighborhood. The orange agents, the blue agents, the yellow agents, the green agents, and the pink agents get along with one another. But each agent wants to make sure that it lives near some of "its own." That is, each orange agent wants to live near at least some orange agents, each blue agent wants to live near at least some blue agents, and etc. The simulation shows how these individual preferences ripple through the neighborhood, leading to large-scale patterns.
...
@#$#@#$#@
<experiments>
  <experiment name="Segregation Final" repetitions="20" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    ...
    <enumeratedValueSet variable="move-forward">
      <value value="10"/>
    </enumeratedValueSet>
  </experiment>
</experiments>
