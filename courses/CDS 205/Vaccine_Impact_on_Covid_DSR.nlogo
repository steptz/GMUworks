...
@#$#@#$#@
<experiments>
  <experiment name="Part 1" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles with [never-infected?] / num-people * 100</metric>
    <metric>count turtles with [infected?] / num-people * 100</metric>
    <metric>count turtles with [immune?] / num-people * 100</metric>
    <metric>count turtles with [dead?] / num-people * 100</metric>
    <metric>count turtles with [dead?]</metric>
    <metric>cumulative-infections</metric>
    <enumeratedValueSet variable="transmissibility-scalar">
      <value value="0.7"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="treatment-capacity">
      <value value="500"/>
    </enumeratedValueSet>
    ...
    <enumeratedValueSet variable="base-length-of-immunity">
      <value value="0"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="Super-Spreader-Threshold">
      <value value="10"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="mask-efficacy">
      <value value="0"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="percent-who-distance">
      <value value="0"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="base-recovery-time">
      <value value="14"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="base-sociability">
      <value value="75"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="base-quarantine-start">
      <value value="5"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="base-prob-of-transmissibility">
      <value value="25"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="shape-r">
      <value value="1.5"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="Transmission-shape-parameter">
      <value value="2"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="percent-who-quarantine">
      <value value="0"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="percent-to-vaccinate">
      <value value="0"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="percent-who-mask">
      <value value="0"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="base-case-fatality-rate">
      <value value="1"/>
    </enumeratedValueSet>
  ...
  <experiment name="Part 2" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles with [never-infected?] / num-people * 100</metric>
    <metric>count turtles with [infected?] / num-people * 100</metric>
  ...
  <experiment name="Part 3 - Distance" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles with [never-infected?] / num-people * 100</metric>
    <metric>count turtles with [infected?] / num-people * 100</metric>
  ...
  <experiment name="Part 3 - Masks" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles with [never-infected?] / num-people * 100</metric>
    <metric>count turtles with [infected?] / num-people * 100</metric>
  ...
  <experiment name="Part 3 - Quarinitine" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles with [never-infected?] / num-people * 100</metric>
    <metric>count turtles with [infected?] / num-people * 100</metric>
  ...
  <experiment name="Part 3 - Vaccinated" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles with [never-infected?] / num-people * 100</metric>
    <metric>count turtles with [infected?] / num-people * 100</metric>
  ...
  <experiment name="Part 4 - Ansence" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles with [never-infected?] / num-people * 100</metric>
    <metric>count turtles with [infected?] / num-people * 100</metric>
  ...
  <experiment name="Part 4 - Presence" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles with [never-infected?] / num-people * 100</metric>
    <metric>count turtles with [infected?] / num-people * 100</metric>
